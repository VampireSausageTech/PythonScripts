import random
msg="\"I like to eat tasty pineapples\" \nHello!"
chars="abcdefghijklmnopqrstuvwxyz .!\n\"(),"
print("Starting Message: "+msg)
...
test1=encrypt(password,msg)
print("Encoded message: " + test1)
test2=encrypt(password,test1)
print("Decoded message: " + test2)
